...
/**
 * This is a subclass of <tt>DataSet</tt> representing a dataset all of whose
 * attributes are numeric. In addition to all of the fields and methods
 * inherited from <tt>DataSet</tt>, the class includes a constructor that reads
 * in data from data files and converts all discrete attributes to numeric.
 **/
